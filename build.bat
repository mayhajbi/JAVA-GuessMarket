...
rem  The ui module (the console application of exercise 1) is kept in the
rem  project for reference only and is not built: the engine of exercise 2
rem  requires a user for every action, which that console does not have.
